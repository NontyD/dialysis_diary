...
class DialysisRecord(models.Model):
    ...
    blood_pressure_systolic = models.IntegerField(help_text="Systolic B P")
    blood_pressure_diastolic = models.IntegerField(help_text="Diastolic B P")
    initial_drain_volume = models.IntegerField(help_text="Drain Volume (ml)")
    total_uf = models.IntegerField(help_text="Total UF (ml)")
    average_dwell = models.DurationField(help_text="Avg Dwell Time (hh:mm)")
